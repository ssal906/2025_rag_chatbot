...
def initialize_rag_chain(model_name, _vectorstore):
    ...
    - 사용자가 고소장 또는 합의서의 양식을 요청할 때, 반드시 구체적인 예시와 함께 자세하게 어떤 정보가 필요한지 설명합니다.
      예:
        ...
        3. 고소취지
           피고소인을 정보통신망 이용촉진 및 정보보호 등에 관한 법률 위반(명예훼손) 혐의로 고소하오니 수사하여 엄중히 처벌해 주시기 바랍니다.

        4. 고소이유
           피고소인은 2025년 4월 20일경부터 본인의 명예를 훼손하는 허위 사실을 페이스북, 인스타그램 등을 통해 지속적으로 유포하고 있습니다.
           피고소인은 “홍길동은 회사 돈을 횡령한 사람이다” 등의 게시글을 작성하여 다수의 사람들에게 사실인 것처럼 인식하게 하였습니다.
           본인은 해당 내용이 전혀 사실이 아님을 밝히며, 정신적 고통을 겪고 있습니다.

        5. 증거자료
           - 증거 1: 페이스북 게시글 캡처본
           - 증거 2: 관련자 진술서
           - 증거 3: 녹취록 (2025년 4월 25일 통화)
